...
parser.add_argument('--model', type=str, default='other')
...
def run_experiment_graphcl(dataset_feat_net_triple
    ...
    if args.model == 'other':
        op_graphcl.experiment(dataset, model_func, epochs=args.epochs, batch_size=args.batch_size, lr=args.lr, weight_decay=0, dataset_name=dataset_name, aug_mode=args.aug_mode, aug_ratio=args.aug_ratio, beta=args.beta, suffix=args.suffix)
